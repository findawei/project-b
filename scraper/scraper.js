...
async function main() {
  ...
  const { data } = await axios.get(
    "https://watchcharts.com/watch/643/rolex-submariner-16613"
  );
  try {
    ...
    return console.log(declarations);
  } catch (e) {
