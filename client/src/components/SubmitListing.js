      ...
      <Grid container direction="column" justify="center" alignItems="center">
        ...
        >
          ...
          <DialogContent>
            <DialogContentText id="alert-dialog-description">
              We've sent you an email with a summary of your submission. We
              should get back to you within 1 business day.
            </DialogContentText>
          </DialogContent>
          <DialogActions>
            ...
            <form onSubmit={handleSubmit(listingSubmit)}>
              <MuiPickersUtilsProvider utils={DateFnsUtils}>
                ...
                <Typography className={classes.radio}>
                  Give us the following info and we’ll quickly review your watch
                  to decide if it’s a fit for No Wait List. If your watch is
                  accepted, we’ll ask for more details and photos, and work with
                  you to get the auction live.
                </Typography>
                    ...
                    {info === "dealer" ? (
                      <>
                        <Grid item xs={12} sm={8}>
                          <Typography>
                            Are there any additional fees the buyer will have to
                            pay?
                          </Typography>
                          <Paper elevation={0}>
                            <TextField
                ...
                <Paper className={classes.paper} elevation={0} color="primary">
                  ...
                  <Grid container spacing={3}>
                    {forsale === "yes" ? (
                      <>
                        <Typography color="secondary" className={classes.input}>
                          If we accept your watch, all other listings will need
                          to be taken down before it can be listed on our site.
                        </Typography>
                        <Grid item xs={12}>
                          <Typography>
                            Please link to all existing listings
                          </Typography>
                          <Paper elevation={0}>
                            <TextField
                              name="link"
                ...
                <Paper className={classes.paper} elevation={0} color="primary">
                  <h1>Reserve Price</h1>
                  <Typography>
                    Do you want to set a minimum price required for your watch
                    to sell?
                  </Typography>
                  <FormControl component="fieldset" className={classes.radio}>
                    {/* <FormLabel component="legend"></FormLabel> */}
                  ...
                  <Grid container spacing={3}>
                    {reserve === "yes" ? (
                      <>
                        <Typography color="secondary" className={classes.input}>
                          Please note there is a $49 fee for having a reserve
                          price.
                        </Typography>
                        <Grid item xs={12} sm={8}>
                          <Typography>
        ...
        <FileUpload />
                ...
                <Paper className={classes.paper} elevation={0} color="primary">
                  <h1>Referral</h1>
                  <Typography>
                    How did you hear about us? If a user referred you please
                    leave their username/email.
                  </Typography>
                  <Grid container spacing={3}>
                    <Grid item xs={12} sm={8}>
                      <Paper elevation={0}>
