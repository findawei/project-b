...
return (
    ...
    <Container>
    <Typography>
    <b>NoWaitList Privacy Policy</b>
    <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from NoWaitList (the &ldquo;Site&rdquo;).</p>
    <p><br/></p>
    ...
    {/* <p>[[INSERT OTHER USES OF DEVICE INFORMATION, INCLUDING: &nbsp;ADVERTISING/RETARGETING]]SHARING YOUR PERSONAL INFORMATION</p> */}
    ...
    <p><br/></p>
    CONTACT US
    <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at info@nowaitlist.co</p>
    <p><br/></p>
    EFFECTIVE DATE
    <p>This Notice is effective December 25, 2020.</p>
    </Typography>
    </Container>
</div>
);
